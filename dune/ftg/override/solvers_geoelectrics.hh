...
#ifndef DUNE_MODELLING_SOLVERS_GEOELECTRICS_HH
#define DUNE_MODELLING_SOLVERS_GEOELECTRICS_HH
...
namespace Dune {
  namespace Modelling {
    ...
    template<typename Traits, typename ModelType, typename DirectionType>
      class StationarySolverERT_CG_AMG_SSOR_reuse_matrix
      {
        private:
        ...
        public:
           ...
           * @brief Constructor
           */
          StationarySolverERT_CG_AMG_SSOR_reuse_matrix(
    ...
    template<typename Traits, typename ModelType, typename DirectionType>
      class TransientSolverERT
      {
        ...
        {}
          ...
          {
            DUNE_THROW(Dune::Exception,"transient solver for ERT model not implemented!");
          }
...
#endif // DUNE_MODELLING_SOLVERS_GEOELECTRICS_HH
